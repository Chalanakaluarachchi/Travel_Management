...
<div className='logo'>
  ...
  <p>Lorem ipsum dolor sit amet 
    ...
    rerum voluptatum! Perferendis quaerat similique, 
    </p>
    ...
    <div className='social__links d-flex align-items-center gap-4'>
      ...
      <span>
        ...
        <h5 className='footer__link-title'>Contact</h5>
          <ListGroup className='footer__quick-links'>
            ...
            gap-3'>
              ...
              <p className='mb-0'>Chalanaravishka2@gmail.com</p>
            ...
            gap-3'>
              ...
              <p className='mb-0'>+94 71 148 9159</p>
        ...
        <Col lg ='12' className='text-center pt-5'>
          <p className='copyright'>Copyright {year}, design and develop by Chalana Ravishka. All rights reserved.</p>
        </Col>
      </Row>
    </Container>
  </footer>
